package com.infinite.user.security.jwt;

import static com.infinite.user.security.AuthoritiesConstants.ADMIN;
import static com.infinite.user.security.SecurityUtils.AUTHORITIES_CLAIM;
import static com.infinite.user.security.SecurityUtils.JWT_ALGORITHM;
